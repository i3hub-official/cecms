        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <span className="font-semibold text-foreground">&quot;{apiKeyName}&quot;</span>?
            </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className={`text-xs ${
                  ...
                  <p className="font-medium">
                    {action === "revoke" ? "This will immediately:" : "This will:"}
                  </p>
                  <ul className="mt-1 list-disc list-inside space-y-0.5">
                    {action === "revoke" ? (
                      ...
                      <>
                        ...
                        <li>Invalidate the current key immediately</li>
                        <li>Show you the new key (copy it immediately!)</li>
                      </>
                    )}
                  </ul>
                </div>
...
const MobileApiKeyCard = ({
  ...
  const canRegenerate = apiKey.isActive && !apiKey.revokedAt && !isExpired(apiKey.expiresAt);
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            ...
            {canRegenerate && (
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 bg-green-50 hover:bg-green-100 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-400 rounded-lg font-medium transition-colors touch-manipulation disabled:opacity-50"
              >
        ...
        <div className="flex items-center space-x-3">
          ...
          {canRegenerate && (
            <button
              ...
              disabled={isRegenerating}
              className="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300 hover:underline text-sm font-medium transition-colors disabled:opacity-50 flex items-center gap-1"
            >
...
interface EnhancedApiKeyListProps extends Omit<ApiKeyListProps, 'onRevoke'> {
  ...
  revokingId: string | null;   // match the original
  regeneratingId: string | null; // keep symmetry if you want
}
